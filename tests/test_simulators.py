...
class TestTraditionalSimulator:
    def test_return_type_and_count(self):
        ...
        noise = _noise(8)
        sim = TraditionalTrajectorySimulator(batch_size=4, rng_seed=42)
    ...
    def test_bitstring_length(self):
        ...
        noise = _noise(8)
        sim = TraditionalTrajectorySimulator(batch_size=n, rng_seed=0)
    ...
    def test_path_found_per_shot(self):
        ...
        noise = _noise(6)
        sim = TraditionalTrajectorySimulator(batch_size=3, rng_seed=1)
    ...
    def test_bitstrings_are_binary_strings(self):
        ...
        noise = _noise(4)
        sim = TraditionalTrajectorySimulator(batch_size=4, rng_seed=2)
        results = sim.sample(circuit, noise, num_shots=5)
        for bs, _ in results:
...
class TestUnoptimizedPTSBESimulator:
    def test_path_found_per_error_set(self):
        ...
        noise = _noise(8)
        E = 3
        sim = UnoptimizedPTSBESimulator(batch_size=4, num_error_sets=E, rng_seed=0)
    ...
    def test_return_list_length_equals_total_shots(self):
        ...
        noise = _noise(6)
        total = 15
        sim = UnoptimizedPTSBESimulator(batch_size=3, num_error_sets=5, rng_seed=1)
    ...
    def test_default_num_error_sets_equals_shots(self):
        ...
        noise = _noise(6)
        num_shots = 5
        sim = UnoptimizedPTSBESimulator(batch_size=3, rng_seed=2)
    ...
    def test_bitstring_length(self):
        ...
        noise = _noise(4)
        sim = UnoptimizedPTSBESimulator(batch_size=n, num_error_sets=2, rng_seed=3)
...
class TestOptimizedPTSBESimulator:
    def test_path_found_once(self):
        ...
        sim = OptimizedPTSBESimulator(
            ...
            num_hypersamples=1, num_error_sets=5, rng_seed=0,
        )
    ...
    def test_final_batch_size_validation(self):
        with pytest.raises(ValueError, match="final_batch_size"):
            sim = OptimizedPTSBESimulator(final_batch_size=100)
            circuit = _small_circuit(n=4, g=4)
    ...
    def test_non_proportional_returns_many_bitstrings(self):
        ...
        sim = OptimizedPTSBESimulator(
            batch_size=2, final_batch_size=2,
            num_hypersamples=1, num_error_sets=3, rng_seed=0,
        )
    ...
    def test_non_proportional_bitstring_length(self):
        ...
        sim = OptimizedPTSBESimulator(
            batch_size=2, final_batch_size=2,
            num_hypersamples=1, num_error_sets=2, rng_seed=1,
        )
    ...
    def test_proportional_mode_shot_count(self):
        ...
        sim = OptimizedPTSBESimulator(
            batch_size=2, final_batch_size=2,
            num_hypersamples=1, num_error_sets=4, rng_seed=2,
        )
    ...
    def test_proportional_born_rule(self):
        ...
        sim = OptimizedPTSBESimulator(
            ...
            num_hypersamples=1, num_error_sets=1, rng_seed=42,
        )
        results = sim.sample(circuit, noise, num_shots=num_shots, mode="proportional")
        counts = {}
        for bs, _ in results:
