...
Provides GPU-accelerated tensor network contraction via cuTensorNet, including path finding, batched marginal contraction, conditional marginal contraction, contraction path caching, and flexible per-batch size control.
