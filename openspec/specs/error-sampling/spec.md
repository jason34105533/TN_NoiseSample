...
Provides proportional and non-proportional (uniform) sampling of error sets from a noise model, assigning shot counts to each sampled error set and serializing results for downstream tensor network construction.
